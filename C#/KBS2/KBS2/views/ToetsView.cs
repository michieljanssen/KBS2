...
namespace KBS2.views
{
    class ToetsView :Panel
    {
        ...
        public ToetsView(Toets toets) :base(){
            this.toets = toets;
            ...
            this.lbl_toetsnaam.Text = "Toetsnaam";
            // 
            ...
            this.lbl_aantalvoldoendes.Text = "Aantal voldoendes:";
            // 
            ...
            this.lbl_percentage.Text = "Percentage gehaald: %";
            // 
            // prb_gehaald
            // 
            ...
            dataGridViewCellStyle1.Font =
                new Font("Microsoft Sans Serif", 16F, FontStyle.Regular, GraphicsUnit.Point, ((byte)(0)));
